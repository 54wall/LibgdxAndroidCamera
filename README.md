...
## 开发背景 ##
  ...
  简单介绍下本文主要介绍了下如何libGDX调用android摄像头的步骤，内容非原创。通过在Libgdx中调用摄像头，可以实现伪AR游戏：一个是抓幽灵的游戏ChaseWhisplyProject，来自 <https://github.com/tvbarthel/ChaseWhisplyProject> 
